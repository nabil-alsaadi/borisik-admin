...
export default function CreateOrUpdateProductForm({
  ...
  const methods = useForm<ProductFormValues>({
    ...
    // @ts-ignore
    defaultValues: getProductDefaultValues(initialValues!, isNewTranslation,locale),
  });
  const {
    register,
    handleSubmit,
  ...
  const onSubmit = async (values: ProductFormValues) => {
    ...
    const inputValues = {
      ...
      ...getProductInputValues(values, initialValues,locale),
      slug: finalSlug,
    };
          ...
          <div className="flex flex-wrap pb-8 my-5 border-b border-dashed border-border-base sm:my-8">
            ...
            <Card className="w-full sm:w-8/12 md:w-2/3">
              ...
              <Input
                ...
                className="mb-5"
              />
              {/* {console.log('errors.translations?.[locale ?? ]?.name?.message!',errors.translations)} */}
