...
export default function Orders() {
  ...
  function handlePagination(current: any) {
    setPage(current);
    // setLastDocumentId(paginatorInfo?.lastDocumentId);
  }
  ...
  const { orders, loading, paginatorInfo, error } = useOrdersQuery({ // here i want to pass paginatorInfo.lastDocumentId
    language: locale,
    limit: 10,
    page,
    orderBy,
